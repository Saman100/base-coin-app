...
contract Ownable is Context {  function getOwner() external view returns (address);
  ...
  function renounceOwnership() public onlyOwner {
    ...
    _owner = address(0);function totalSupply() external view returns (uint256);  function getOwner() external view returns (address);
  }
...
contract g0z is Context, IBEP20, Ownable {
  ...
  mapping (address => mapping (address => uint256)) private _allowances;function totalSupply() external view returns (uint256);  function getOwner() external view returns (address);
  ...
  function decimals() external view returns (uint8) {function totalSupply() external view returns (uint256);
    return _decimals;function totalSupply() external view returns (uint256);function totalSupply() external view returns (uint256);
  }

  function symbol() external view returns (string memory) {
    return _symbol;function totalSupply() external view returns (uint256)
  }

  function totalSupply() external view returns (uint256) {function totalSupply() external view returns (uint256);
    return _totalSupply;function totalSupply() external view returns (uint256);
  }
...
function totalSupply() external view returns (uint2
  function transferFrom(address sender, address recipient, uint256 amount) external returns (bool) {
  ...
  function _mint(address account, uint256 amount) internal {
    require(account != address(0), "BEP20: mint to the zero addr
